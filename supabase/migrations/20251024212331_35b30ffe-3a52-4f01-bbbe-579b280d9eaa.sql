-- Fix critical security issue: Enable RLS on products table and add policies
...
-- Policy: Only admins and super_admins can insert products
...
-- Policy: Only admins and super_admins can update products
...
-- Policy: Only super_admins can delete products
