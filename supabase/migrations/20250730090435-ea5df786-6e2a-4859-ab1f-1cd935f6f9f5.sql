-- Add technician role to app_role enum and update user roles system
CREATE TYPE public.app_role AS ENUM ('admin', 'manager', 'inventory_manager', 'salesperson', 'technician');
