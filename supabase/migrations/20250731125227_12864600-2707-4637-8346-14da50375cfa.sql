...
-- Insert major brands across categories (using correct category IDs)
...
JOIN (VALUES
  ...
  -- Apple MacBooks
  ('Apple', 'MacBook Pro 16', 9, ARRAY['512GB', '1TB', '2TB', '4TB', '8TB'], ARRAY['Silver', 'Space Gray'], 2023),
  ('Apple', 'MacBook Pro 14', 9, ARRAY['512GB', '1TB', '2TB', '4TB', '8TB'], ARRAY['Silver', 'Space Gray'], 2023),
  ('Apple', 'MacBook Air 15', 9, ARRAY['256GB', '512GB', '1TB', '2TB'], ARRAY['Midnight', 'Starlight', 'Silver', 'Space Gray'], 2023),
  ('Apple', 'MacBook Air 13', 9, ARRAY['256GB', '512GB', '1TB', '2TB'], ARRAY['Midnight', 'Starlight', 'Silver', 'Space Gray'], 2022),
  ...
  -- Audio Products
  ('Apple', 'AirPods Pro 2', 11, ARRAY[''], ARRAY['White'], 2022),
  ('Apple', 'AirPods 3', 11, ARRAY[''], ARRAY['White'], 2021),
  ('Apple', 'AirPods Max', 11, ARRAY[''], ARRAY['Space Gray', 'Silver', 'Sky Blue', 'Green', 'Pink'], 2020),
  ('Sony', 'WH-1000XM5', 11, ARRAY[''], ARRAY['Black', 'Silver'], 2022),
  ('Sony', 'WH-1000XM4', 11, ARRAY[''], ARRAY['Black', 'Silver', 'Blue'], 2020),
  ('Sony', 'WF-1000XM4', 11, ARRAY[''], ARRAY['Black', 'Silver'], 2021),
  ('Bose', 'QuietComfort 45', 11, ARRAY[''], ARRAY['Black', 'White Smoke'], 2021),
  ('Bose', 'QuietComfort Earbuds', 11, ARRAY[''], ARRAY['Triple Black', 'Soapstone'], 2020),
  ('JBL', 'Live 660NC', 11, ARRAY[''], ARRAY['Black', 'Blue', 'Pink', 'White'], 2021),
  ('Sennheiser', 'Momentum 4', 11, ARRAY[''], ARRAY['Black', 'White'], 2022),

  -- Computer models
  ('Dell', 'XPS 13', 9, ARRAY['256GB', '512GB', '1TB'], ARRAY['Platinum Silver', 'Graphite'], 2023),
  ('Dell', 'XPS 15', 9, ARRAY['512GB', '1TB', '2TB'], ARRAY['Platinum Silver', 'Graphite'], 2023),
  ('HP', 'Spectre x360', 9, ARRAY['256GB', '512GB', '1TB'], ARRAY['Natural Silver', 'Nightfall Black'], 2023),
  ('HP', 'EliteBook 840', 9, ARRAY['256GB', '512GB', '1TB'], ARRAY['Silver'], 2023),
  ('ASUS', 'ZenBook 14', 9, ARRAY['256GB', '512GB', '1TB'], ARRAY['Pine Grey', 'Ponder Blue'], 2023),
  ('ASUS', 'ROG Strix G15', 9, ARRAY['512GB', '1TB'], ARRAY['Eclipse Gray', 'Original Black'], 2023),

  -- Microsoft tablets
  ('Microsoft', 'Surface Pro 9', 3, ARRAY['128GB', '256GB', '512GB', '1TB'], ARRAY['Platinum', 'Graphite', 'Sapphire', 'Forest'], 2022),
  ('Microsoft', 'Surface Laptop 5', 9, ARRAY['256GB', '512GB', '1TB'], ARRAY['Platinum', 'Matte Black', 'Sandstone', 'Sage'], 2022),

  -- Accessory products
  ('Anker', 'PowerCore 10000', 2, ARRAY[''], ARRAY['Black', 'White'], 2023),
  ('Anker', 'PowerWave 10', 2, ARRAY[''], ARRAY['Black', 'White'], 2023),
  ('Belkin', 'BoostCharge Pro', 2, ARRAY[''], ARRAY['Black', 'White'], 2023),
  ('Logitech', 'MX Master 3S', 2, ARRAY[''], ARRAY['Graphite', 'Pale Gray'], 2022),
  ('Logitech', 'MX Keys', 2, ARRAY[''], ARRAY['Graphite', 'Pale Gray'], 2021)
