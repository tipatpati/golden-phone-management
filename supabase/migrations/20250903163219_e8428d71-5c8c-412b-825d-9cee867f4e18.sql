...
CREATE POLICY IF NOT EXISTS "Admins and managers can view all sales"
ON public.sales
FOR SELECT
...
CREATE POLICY IF NOT EXISTS "Admins and managers can manage sale items"
...
CREATE POLICY IF NOT EXISTS "Salespersons manage own sale items"
ON public.sale_items
FOR ALL
USING (
