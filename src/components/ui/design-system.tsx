...
export const responsiveDialogVariants = cva(
  "w-[95vw] sm:w-full",
  {
    variants: {
      size: {
        sm: "max-w-md md:max-w-sm max-h-[85vh] overflow-y-auto p-4 sm:p-6",
        md: "max-w-2xl md:max-w-xl max-h-[85vh] overflow-y-auto p-4 sm:p-6 md:p-8",
        lg: "max-w-4xl md:max-w-2xl max-h-[85vh] sm:max-h-[90vh] overflow-y-auto p-4 sm:p-6",
        xl: "max-w-6xl md:max-w-3xl max-h-[90vh] overflow-y-auto p-6 sm:p-8",
      }
    },
    defaultVariants: {
      size: "md",
