    ...
    <div className="grid gap-6 md:grid-cols-3">
      <Card className="border-0 shadow-xl bg-gradient-to-br from-blue-50 to-blue-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
          <CardTitle className="text-sm font-semibold text-blue-700 uppercase tracking-wider">Ricavi Totali</CardTitle>
        ...
        <CardContent className="space-y-2">
          ...
          <p className="text-sm text-blue-600 font-medium">da {totalSales} vendite totali</p>
        </CardContent>
      </Card>
      ...
      <Card className="border-0 shadow-xl bg-gradient-to-br from-green-50 to-green-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
          <CardTitle className="text-sm font-semibold text-green-700 uppercase tracking-wider">Vendite Totali</CardTitle>
        ...
        <CardContent className="space-y-2">
          ...
          <p className="text-sm text-green-600 font-medium">transazioni completate</p>
        </CardContent>
      </Card>
      ...
      <Card className="border-0 shadow-xl bg-gradient-to-br from-purple-50 to-purple-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
          <CardTitle className="text-sm font-semibold text-purple-700 uppercase tracking-wider">Vendita Media</CardTitle>
        ...
        <CardContent className="space-y-2">
          ...
          <p className="text-sm text-purple-600 font-medium">per transazione</p>
        </CardContent>
      </Card>
    </div>
  );
